...
public class WordJumble {
	...
	public static void main(String[] args) {
        ...
        //Condition to ensure sentance start with uppercase
        ...
        //breaking input stream into tokens parts
        String inputString = Character.toLowerCase(str.charAt(0)) + str.substring(1, len);
